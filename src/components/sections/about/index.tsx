        ...
        <>
            <Row>
                <Col md={6} xs={12}>
                    ...
                    <div>
                        <div>
                            <p> Hi Everyone, I am Edan Nguyen from Hanoi, VietNam.</p>

                            <p> I am currently employed as a a freelance dev (start-up).</p>

                            <p> I have completed Bachelor's degree in Software Engineer at ACE - Aptech Computer Education (FPT Aptech).</p>
                        </div>
                    </div>
                    <div>
                                    ...
                                    <div className="experience-container">
                                        ...
                                        <div className="details">
                                            ...
                                            <div className="info">
                                                ...
                                                <p className="company">ACE - Aptech Computer Education (FPT Aptech)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
